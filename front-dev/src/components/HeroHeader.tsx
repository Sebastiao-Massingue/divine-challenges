      ...
      <div className={classes.inner}>
        ...
        <Container size={640}>
          <Text size="lg" className={classes.description}>
            O melhor site com mais de 700 empresas encontra-se aqui. Essas empresas disponibilizam
            vários serviço e são empresas Mundias. 
          </Text>
        </Container>

        <div className={classes.controls}>
          <Button onClick={()=>router.push("/allCompany")} className={classes.control} variant="white" size="lg">
            Iniciar
          </Button>
